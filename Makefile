...
generate-roughness-array:
	 convert -append \
			$(BLACK_TEXTURE) \
			$(TEXTURE_ARRAY_SOURCE)/Ground080_1K-JPG/Ground080_1K-JPG_Roughness.jpg \
			$(TEXTURE_ARRAY_SOURCE)/Ground082L_1K-JPG/Ground082L_1K-JPG_Roughness.jpg \
			$(TEXTURE_ARRAY_SOURCE)/Grass001_1K-JPG/Grass001_1K-JPG_Roughness.jpg \
			$(TEXTURE_ARRAY_SOURCE)/Rock030_1K-JPG/Rock030_1K-JPG_Roughness.jpg \
			$(TEXTURE_ARRAY_SOURCE)/Snow010A_1K-JPG/Snow010A_1K-JPG_Roughness.jpg \
			$(ROUGHNESS_ARRAY_OUTPUT)
